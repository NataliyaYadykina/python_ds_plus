...
# и добавлять дополнительную информацию
# о создателе строки и времени ее создания.
...
# В этом методе создается новый объект MyStr
...
# который возвращает строковое представление объекта класса MyStr.
# Метод __repr__ возвращает строку,
# которая может быть использована для создания точно такого же
# объектаMyStrс теми же значениямиvalueиauthor`.
...
# (Автор: John, Время создания: [ в формате '%Y-%m-%d %H:%M'])
# На входе:
