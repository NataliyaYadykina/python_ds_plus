...
# Напишите к ней тесты, используя unittest и лежать
# в class TestRectangle(unittest.TestCase)
# Тесты:
# test_width: Тестирование инициализации ширины.
# Создайте прямоугольник с шириной 5 и убедитесь,
...
# Попробуйте создать прямоугольник с шириной 5 и отрицательной высотой (-4)
# и убедитесь, что это вызывает исключение NegativeValueError.
# test_set_width: Тестирование изменения ширины.
# Создайте прямоугольник с шириной 5 и измените его ширину на 10.
...
# Создайте прямоугольник с шириной 5 и попробуйте изменить
# его ширину на отрицательное значение (-10).
# Убедитесь, что это вызывает исключение NegativeValueError.
# test_set_height: Тестирование изменения высоты.
# Создайте прямоугольник с шириной 3 и высотой 4
# и измените его высоту на 6.
...
# Создайте два прямоугольника: один с шириной 3 и высотой 4,
# другой с шириной 10. Попробуйте выполнить операцию вычитания r1 - r2
# и убедитесь, что это вызывает исключение NegativeValueError.
# test_subtraction_same_perimeter:
# Тестирование операции вычитания с прямоугольниками одинакового периметра.
# Создайте два прямоугольника: один с шириной 5,
# другой с шириной 4 и высотой 3.
# Выполните операцию вычитания r1 - r2 и убедитесь,
# что полученный прямоугольник имеет
# правильные значения ширины и высоты (1 и 1.0 соответственно).
...
# unittest.main()
# На выходе после автоматической обрезки
# информации в тестах вы должны получить:
# FAILED (failures=1)
...
class Rectangle:
    ...
    def __sub__(self, other):
        if self.perimeter() < other.perimeter():
            ...
            raise NegativeValueError(
                f'Ширина должна быть положительной, а не {self.width - other.width}'
            )
