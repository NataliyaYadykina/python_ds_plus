...
# и обрабатывает некорректные значения.
...
# Создайте объект Rectangle с шириной 5 и убедитесь,
...
# и убедитесь, что высота установлена правильно.
# test_perimeter: Тестирование вычисления периметра.
# Создайте объект Rectangle с шириной 5
# и вычислите его периметр (должен быть равен 20).
...
# Создайте два объекта Rectangle с ширинами 5 и 3,
# и высотами 1 и 4 соответственно.
# Произведите операцию сложения и убедитесь,
...
# Создайте два объекта Rectangle с ширинами 10 и 3,
# и высотами 1 и 4 соответственно. Произведите операцию вычитания
# и убедитесь, что полученный прямоугольник
...
# Создайте два объекта Rectangle с ширинами 3 и 10,
# и высотами 4 и 1 соответственно.
# Попробуйте выполнить операцию вычитания и убедитесь,
# что это вызывает исключение NegativeValueError.
# test_subtraction_same_perimeter:
# Тестирование операции вычитания с одинаковым периметром.
# Создайте два объекта Rectangle с ширинами 5 и 4,
# и высотами 1 и 3 соответственно.
# Произведите операцию вычитания и убедитесь,
# что полученный прямоугольник имеет
# правильные значения ширины и высоты.
